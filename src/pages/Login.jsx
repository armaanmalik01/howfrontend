...
const Login = () => {
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      localStorage.setItem("ref_code" , res.data.data?.user?.referralCode);
    ...
    <div className="registration-container">
      ...
      >
        ...
        >
          ...
          >
            <Input.Password size='large' prefix={<LockOutlined />} placeholder="Confirm password" style={{ borderRadius: '0.5rem' }} />
          </Form.Item> */}
